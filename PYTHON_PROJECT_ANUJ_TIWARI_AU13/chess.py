...
def welcome():
    ...
    Welcome Screen Credit : <a href='https://www.freepik.com/photos/business'>Business photo created by jcomp - www.freepik.com</a>
    '''
    # wood background
    menubg = pygame.image.load("assets/menubg.jpg").convert()
    screen.blit(menubg, (0, 0))
    bigfont = pygame.font.Font("assets/Roboto-Black.ttf", 80)
    textsurface = bigfont.render('THE CHESS GAME', False, (255, 255, 255))
    screen.blit(textsurface, (30, 10))

    medfont = pygame.font.Font("assets/Roboto-Black.ttf", 30)
    textsurface = medfont.render(
        'By Anuj Tiwari', False, (200, 200, 200))
